class AnalyticsManager {
      ...
      <div class="analytics-container">
        <div class="analytics-header">
          <h1>
            ...
            <span data-i18n="analytics.title">Glucose Analytics</span>
          </h1>
        </div>
          ...
          <div class="analytics-card">
            <div class="analytics-card-header">
              <h2>
                ...
                <span data-i18n="analytics.weekly">Weekly Trend</span>
              </h2>
          ...
          <div class="analytics-card">
            <div class="analytics-card-header">
              <h2>
                ...
                <span data-i18n="analytics.monthly">Monthly Trend</span>
              </h2>
          ...
          <div class="analytics-card">
            <div class="analytics-card-header">
              <h2>
                ...
                <span data-i18n="analytics.time_in_range">Time in Range</span>
              </h2>
            </div>
            ...
            <div class="analytics-card">
              <div class="analytics-card-header">
                <h2>
                  ...
                  <span data-i18n="analytics.insulin_impact">Insulin Effect</span>
                </h2>
              </div>
          ...
          <div class="analytics-card risk-flags-container">
            <div class="analytics-card-header">
              <h2>
                ...
                <span data-i18n="analytics.risk_flags">Risk Alerts</span>
              </h2>
            </div>
  ...
  renderWeeklyChart(data) {
    ...
    this.charts.weekly = new Chart(ctx, {
      type: 'line',
      data: {
        labels: data.days.map(d => new Date(d._id).toLocaleDateString('en-US', { weekday: 'short' })),
        datasets: [
          {
            label: 'Average',
    ...
    document.getElementById('weeklyStats').innerHTML = `
      <div class="stat-item">
        ...
        <div class="stat-label">Avg mg/dL</div>
      </div>
      <div class="stat-item">
  ...
  renderMonthlyChart(data) {
    ...
    this.charts.monthly = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: sampledData.map(d => new Date(d._id).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })),
        datasets: [{
  ...
  renderTimeInRange(timeInRange) {
    document.getElementById('rangeBar').innerHTML = `
      <div class="range-segment very-low" style="width: ${timeInRange.veryLow}%">
        ${timeInRange.veryLow > 5 ? timeInRange.veryLow + '%' : ''}
      </div>
      <div class="range-segment low" style="width: ${timeInRange.low}%">
        ${timeInRange.low > 5 ? timeInRange.low + '%' : ''}
      </div>
      <div class="range-segment target" style="width: ${timeInRange.target}%">
        ${timeInRange.target}%
      </div>
      <div class="range-segment high" style="width: ${timeInRange.high}%">
        ${timeInRange.high > 5 ? timeInRange.high + '%' : ''}
      </div>
      <div class="range-segment very-high" style="width: ${timeInRange.veryHigh}%">
    ...
    document.getElementById('insulinImpactContent').innerHTML = `
      <div class="stats-grid">
        <div class="stat-item">
          ...
          <div class="stat-label">Avg Drop/Unit</div>
        </div>
        <div class="stat-item">
          <div class="stat-value">${data.totalAnalyzed}</div>
          <div class="stat-label">Doses Analyzed</div>
        </div>
        <div class="stat-item">
          <div class="stat-value">${data.overallControl.replace('_', ' ')}</div>
          <div class="stat-label">Control Status</div>
        </div>
      </div>
